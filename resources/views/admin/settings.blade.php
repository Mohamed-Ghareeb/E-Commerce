    ...
    <div class="box-body">
        ...
        <div class="form-group">
          ...
          @if (!empty(setting()->logo))
              <img src="{{ Storage::url(setting()->logo) }}" style="width:100px;height:80px">
          @endif
        </div>
        <div class="form-group">
          ...
          @if (!empty(setting()->icon))
            <img src="{{ Storage::url(setting()->icon) }}" style="width:100px;height:80px">
          @endif
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          {!! Form::select('main_lang',
            ['en' => trans('admin.en'), 'ar' => trans('admin.ar')],
            setting()->main_lang,
            ['class' => 'form-control']) !!}
        </div>
        <div class="form-group">
          ...
          {!! Form::select('status',
            ['open' => trans('admin.open'), 'closed' => trans('admin.closed')],
            setting()->status,
            ['class' => 'form-control']) !!}
        </div>
        <div class="form-group">
