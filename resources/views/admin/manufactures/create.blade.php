  ...
  <div class="box">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
          ...
          {!! Form::text('man_name_en', old('man_name_en'), ['class' => 'form-control']) !!}
        </div>
        <div class="form-group">
          {!! Form::label('man_name_ar', trans('admin.name_ar')) !!}
          {!! Form::text('man_name_ar', old('man_name_ar'), ['class' => 'form-control']) !!}
        </div>
        <div class="form-group">
        ...
        {!! Form::submit(trans('admin.create_manufactures'), ['class' => 'btn btn-primary']) !!}
        {!! Form::close() !!}
    </div>
    <!-- /.box-body -->
  </div>
