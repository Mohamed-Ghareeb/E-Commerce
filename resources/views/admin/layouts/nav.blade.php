    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview {{ active_menu('admin')[0] }}">
        ...
        <ul class="treeview-menu" style="{{ active_menu('admin')[1] }}">
          <li class="active"><a href="{{ aurl('') }}"><i class="fa fa-users"></i> {{ trans('admin.dashboard') }}</a></li>
          <li class="active"><a href="{{ aurl('settings') }}"><i class="fa fa-gear"></i> {{ trans('admin.settings') }}</a></li>
      ...
      <li class="treeview {{ active_menu('manufactures')[0] }}">
        <a href="#">
          <i class="fa fa-cube"></i> <span>{{ trans('admin.manufactures') }}</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
        <ul class="treeview-menu" style="{{ active_menu('manufactures')[1] }}">
          <li class=""><a href="{{ aurl('manufactures') }}"><i class="fa fa-cube"></i> {{ trans('admin.manufactures') }}</a></li>
      ...
      <li class="treeview {{ active_menu('shippings')[0] }}">
        ...
        <ul class="treeview-menu" style="{{ active_menu('shippings')[1] }}">
          <li class=""><a href="{{ aurl('shippings') }}"><i class="fa fa-cube"></i> {{ trans('admin.shippings') }}</a></li>
